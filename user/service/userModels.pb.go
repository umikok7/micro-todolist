...
func (x *UserDetailResponse) Reset() {
	*x = UserDetailResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_userModels_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserDetailResponse) Descriptor() ([]byte, []int) {
	return file_userModels_proto_rawDescGZIP(), []int{2}
}
...
var file_userModels_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_userModels_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_userModels_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
